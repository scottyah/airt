...
class Gallery {
  ...
  setupEventListeners() {
    // Search input
    if (this.searchInput) {
      // ⚡ OPTIMIZATION: Debounce search input to prevent excessive re-rendering on every keystroke.
      // This improves UI responsiveness by filtering only after the user has stopped typing for 300ms.
